...
class TestsControllerTest < ActionController::TestCase
  ...
  test "should create test" do
    assert_difference('Test.count') do
      post :create, test: { description: @test.description, title: @test.title, user_id: @test.user_id }
    end
  ...
  test "should update test" do
    put :update, id: @test, test: { description: @test.description, title: @test.title, user_id: @test.user_id }
    assert_redirected_to test_path(assigns(:test))
  end
